...
def RestriccionesLambda(x, w1, w2, lam, meta1, meta2):
    m1 = x[0]**2 - w1 * x[1] - meta1
    m2 = (x[0] - 2)**2 - w2 * x[1] - meta2
    r1 = max(0, m1)
    r2 = max(0, m2)
    return r1 + r2
...
def ObtenMetas(FuncionObjetivo1, FuncionObjetivo2, FunLambda, Restricciones, RestriccionesLambda, limites, tamPoblacion, CR, iteraciones, pesos):
    ...
    tk1, _ = EvolucionDiferencial(FuncionObjetivo1, Restricciones, [limites[0]], tamPoblacion, CR, iteraciones, 0, 0, 0, 0, 0)
    tk2, _ = EvolucionDiferencial(FuncionObjetivo2, Restricciones, [limites[0]], tamPoblacion, CR, iteraciones, 0, 0, 0, 0, 0)
    ...
    for w in np.linspace(0, 1, pesos):
        ...
        limites_lambda = [limites[0], (0, 10**6)]
