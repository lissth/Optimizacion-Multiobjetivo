...
def RestriccionesMeta(x, Tk1, Tk2):
    n1, n2, p1, p2 = x[2], x[3], x[4], x[5]
    h1 = (4*x[0]**2) + (4*x[1]**2) + p1 - n1 - Tk1
    h2 = (x[0]-5)**2 + (x[1]-5)**2 + p2 - n2 - Tk2
...
def Metas(limites, tamPoblacion, CR, iteraciones, numPesos):
    ...
    x1, _ = EvolucionDiferencial(FuncionObjetivo1, Restricciones, [limites[0], limites[1]], tamPoblacion, CR, iteraciones)
    x2, _ = EvolucionDiferencial(FuncionObjetivo2, Restricciones, [limites[0], limites[1]], tamPoblacion, CR, iteraciones)
    ...
    for i in range(numPesos):
        ...
        limitesMeta = [limites[0], limites[1], (0, 100), (0, 100), (0, 100), (0, 100)]
